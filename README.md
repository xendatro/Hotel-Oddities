...
- ReplicatedStorage\Services\ViewmodelDebugService.luau — F3 developer panel for tuning walkie-talkie placement per pose, with pose-inclusive config output.
