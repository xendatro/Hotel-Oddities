...
- Requires: `Configs.ViewmodelConfig` (`Scale`, `Fit`, `HandOffset`, `SwayAmount`, `ChaseSwayAmount`, `Arm`, `Overrides`), `ChaserCameraService`, `MathService`, `SurfaceCursorService` (face geometry for framed poses)
