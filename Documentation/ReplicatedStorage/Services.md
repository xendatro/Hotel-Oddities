...
While any warning is audible the service holds `AmbienceService:Suppress`, muting the game's ordinary ambience playlist, and releases it on every exit path — including when the last warning stops and when the voices tear down.
