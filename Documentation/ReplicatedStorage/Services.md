...
The gate is not a hard edge: the bed's target gain ramps from full to nothing over the last `RedFadeBand` studs of `RedHearingRange`, so walking out of the red decays rather than dropping off a cliff into the fade-out.
