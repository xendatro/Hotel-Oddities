...
- Requires: `Services.CommunicationService`; expects the server `WallstickService` to have installed the `Assets` player scripts, collision groups and streaming foci
